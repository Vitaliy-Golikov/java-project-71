...
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=Vitaliy-Golikov_java-project-71&metric=coverage)](https://sonarcloud.io/summary/new_code?id=Vitaliy-Golikov_java-project-71)
...
## Описание
Программа для сравнения двух конфигурационных файлов и вывода их различий.

## Требования
- Java 21
- Gradle (или использование обёртки `gradlew`)
